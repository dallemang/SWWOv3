...
In the document web today, there are informal models that help people
...
approach, and it indeed describes the state of the document web as it is
...
\begin{figure}
    \centering
    \includegraphics[width=5.0in]{media/f02-04ac-9780123859655.jpg}
...
The Semantic Web, just like the document web that preceded it, is based
