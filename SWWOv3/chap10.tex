...
\texttt{:FHEO_filed_case-0}), and with  predicates about the basis, filing date, and
...
We can now express the status of \texttt{:FHEO_filed_case-0} as a case of disability
...
\begin{figure}
    \centering
    \includegraphics[width=5in]{media/ch10/Figurech10.3.png}
