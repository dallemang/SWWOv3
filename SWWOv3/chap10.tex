...
The fourth case is an example that uses RDFS-Plus to represent linkages between data sets
on the web. 
...
The fourth example, \emph{BridgeDb}\cite{batchelor2014scientific}, is a data set that links other data
