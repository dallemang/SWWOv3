...
UniProt's service provides a good example of URI redirection.  The persistent URI is \textt{http://purl.uniprot.org/uniprot/P43121}.  
...
So far, we have used different tricks (different URLs) to see the
...
manually the dereferencing of an HTTP URI and the content
negotiation. For this, you may use different tools or commands and even
do it from a programming language if you want. Here we use the \texttt{CURL}
...
As show in Figure~\ref{fig:ch5.11}, this tool allow us to perform calls as command
