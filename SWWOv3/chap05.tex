...
\begin{figure}
    ...
    \caption{``Building'' at Wikidata: extract of the HTML rendering for humans.  From wikidata.org, licensed under CC-BY-SA.}
    \label{fig:ch5.9}
\end{figure}
...
machines. From wikidata.org, licensed under CC-BY-SA.}
    \label{fig:ch5.10}
\end{figure}
...
data of two data sets are linked  in the sense of Section~\ref{linking-rdf-data}, i.e. if one data set reuses some
