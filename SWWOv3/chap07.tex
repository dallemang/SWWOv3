...
one of these HTTP URIs, the result (which is maintained by the same publisher, the W3C) is a description of that resource.  If you paste the HTTP URI \texttt{http://www.w3.org/ns/shacl#} into a web browser, you will see the W3C Recommendation document that describes SHACL.
