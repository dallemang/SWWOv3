...
short \cite{QUDT}. It addresses an obvious problem that must be solved in any
...
of Biological Interest (CHEBI, for short). CHEBI \cite{PMID:26467479} (http://obofoundry.org/ontology/chebi.html) \footnote{CHEBI is licensed under CC BY 4.0 https://creativecommons.org/licenses/by/4.0/} is being developed and
...
who has done this research to publish their results.  This is idea behind BridgeDb \cite{van2010bridgedb}.
...
Figure~\ref{fig:ch14.gleifLEI} \cite{GLEIF} \footnote{the GLEIF uses OWL to represent LEI registration, as published at 
www.gleif.org}
