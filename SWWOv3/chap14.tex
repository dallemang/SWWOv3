...
The first is the \emph{Financial Industry Business Ontology} (\emph{FIBO} for short).
...
(like the resources \texttt{qudt:QuantityKind} and \texttt{qudt:Unit}) are in the \textt{qudt:}
