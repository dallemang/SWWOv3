...
Figure~\ref{fig:ch5.4} shows a fragment of the data graph, and the graph pattern,
...
the data; and all four bindings of \texttt{?a} and \texttt{?b} to director:8533 and
