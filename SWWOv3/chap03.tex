...
with simple names like \emphh{Shakespeare} or \emphh{Wales}. On the Semantic Web, this
...
everyone agrees refers to as \emphh{Shakespeare}? When referring to agreement on
...
word \emphh{Shakespeare}?

RDF borrows its solution to this problem from foundational Web
technology --- in particular, the \emphh{URI}. The basic syntax and format of a URI are
