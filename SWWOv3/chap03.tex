...
\begin{figure}
    \centering
    \includegraphics[width=5.0in]{media/ch3/fig3-1.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=5.0in]{media/ch3/fig3-2.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=5.0in]{SWWOv3/media/ch3/fig3-3.png}
...
properties in RDF. The global URI for the rdf namespace is 
...
table---that is, for n rows and c columns, there will be $n \times c$ triples.
...
\begin{figure}
    \centering
    \includegraphics[width=5.0in]{SWWOv3/media/ch3/figure3-7.png}
...
JSON, the W3C has recommended JSON-LD, JSON for Linked Data \cite{Kellogg:14:JF}. There is a
...
to represent the conjecture that Shakespeare had a mistress, whose identity
