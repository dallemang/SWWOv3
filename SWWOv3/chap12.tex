...
the the example of transitive superproperties from Section~\ref{chal:17}.
...
\begin{lstlisting}
anc:DescendantOfWillem a owl:Class ;
    owl:equivalentClass [ a owl:Restriction ;
                          owl:onProperty anc:hasAncestor ;
                          owl:hasValue anc:WillemAlexander
                        ] .

anc:DescendantOfBeatrix a owl:Class ;
     owl:equivalentClass [ a owl:Restriction ;
                           owl:onProperty anc:hasAncestor ;
                           owl:hasValue anc:Beatrix
                         ] .

anc:DescendantOfWilhelmina a owl:Class ;
        owl:equivalentClass [ a owl:Restriction ;
                              owl:onProperty anc:hasAncestor ;
...
What inferences can we draw?  Evidently, each child is a member of
the corresponding descendant class for their parent: 

\begin{lstlisting}
* anc:Alexia a anc:DescendantOfWillemAlexander .
* anc:WillemAlexander a anc:DescendantOfBeatrix .
* anc:Beatrix a anc:DescendantOfWilhelmina .
\end{lstlisting}
...
\begin{lstlisting}
* anc:Alexia a anc:DescendantOfBeatrix .
* anc:Alexia a anc:DescendantOfWilhelmina .
\end{lstlisting}

But we can generalize this; since any child of Willem Alexander  would also be a child 
of Beatrix and of Wilhelmina, we can conclude
